Public Class frmQLSP
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        '    Dim frm As New frmAddKhachhang(False)
        '    frm.txtTitle.Text = "Thêm Hóa Đơn"
        '    frm.Label1.Text = "Mã HĐ:"
        '    frm.Label2.Text = "Mã KH"
        '    frm.Label3.Text = "Địa chỉ"
        '    frm.Label4.Text = "Số ĐT"
        '    frm.txtTenKH.Text = Me.cmbSanpham.SelectedValue
        '    frm.ShowDialog()
    ...
    Private Sub RadiobuttonTheLoai_CheckedChanged(sender As Object, e As EventArgs) Handles RadiobuttonTheLoai.CheckedChanged
        If RadiobuttonTheLoai.Checked Then
